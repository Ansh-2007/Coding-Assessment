...
def data_base():
    ...
    if first_name and last_name:
        ...
        first_name_entry.delte(0, tkinter.END)
        last_name_entry.delete(0, tkinter.END)
        hire_item_combobox.delete(0, tkinter.END)
...
def hire_page():
    ...
    done_hire_button = tkinter.Button(hire_frame_label, text="Add To Cart", command=receipt_page)
