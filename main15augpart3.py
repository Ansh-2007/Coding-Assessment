    ...
    def process_return():
        ...
        try:
            with open("data.txt", "r") as file:
                ...
                for line in lines:
                    # Ensure the line has the right format before accessing it
                    parts = line.split(",")
...
def hire_page():
    ...
    home_button = tkinter.Button(hire_frame, text="Back", command= homepage, bg="light blue", fg="black", font=("Helvetica", 10))
...
window.geometry("600x600")  # Increased window size for better visibility
...
# Create a LabelFrame to hold the buttons and add the image to the frame
frame_label = tkinter.LabelFrame(frame, bg="light blue", font=("Helvetica", 12, "bold"))
frame_label.pack(padx=10, pady=10, fill="both", expand=True)

# Add the image to a Label widget and place it at the top of the frame
title_label = tkinter.Label(frame_label, image=img, bg="light blue")
title_label.pack(pady=10)  # Packing the image at the top

# Create a frame for buttons to use pack layout
button_frame = tkinter.Frame(frame_label, bg="light blue")
button_frame.pack(pady=10, fill="both", expand=True)

# Add buttons to the button_frame using pack
hire_button = tkinter.Button(button_frame, text="Hire", command=hire_page, bg="white", fg="black", font=("Helvetica", 10))
hire_button.pack(padx=5, pady=10, fill="x")

return_button = tkinter.Button(button_frame, text="Return", command=return_page, bg="white", fg="black", font=("Helvetica", 10))
return_button.pack(padx=5, pady=10, fill="x")

view_receipts = tkinter.Button(button_frame, text="View Receipt", command=display_hired_items, bg="white", fg="black", font=("Helvetica", 10))
view_receipts.pack(padx=5, pady=10, fill="x")

quit_button = tkinter.Button(button_frame, text="Quit", command=quit, bg="white", fg="black", font=("Helvetica", 10))
quit_button.pack(padx=5, pady=10, fill="x")
