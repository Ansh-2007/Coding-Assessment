...
hire_button = tkinter.Button(window, text="Hire", command=hire_page, bg="white", fg="black", font=("Helvetica", 10))
hire_button.pack(pady=10)
hire_button.config(height=1, width=20)

return_button = tkinter.Button(window, text="Return", command=return_page, bg="white", fg="black", font=("Helvetica", 10))
return_button.pack(pady=10)
return_button.config(height=1, width=20)

view_receipts = tkinter.Button(window, text="View Receipt", command=display_hired_items, bg="white", fg="black", font=("Helvetica", 10))
view_receipts.pack(pady=10)
view_receipts.config(height=1, width=20)

quit_button = tkinter.Button(window, text="Quit", command=quit, bg="white", fg="black", font=("Helvetica", 10))
